    ...
    <div className="w-full relative sm:h-[56vw] h-[120vw] bg-gradient-to-r from-black via-zinc-900 to-black px-[7vw]">
      <div className="w-full h-full flex sm:flex-row flex-col justify-between sm:items-center z-20">
        <div className="flex flex-col gap-[5vw] z-10">
          <div className="sm:w-[30vw] w-[50vw] flex flex-col gap-[2vw] pt-[8vw]">
            ...
            <h1 className="sm:text-[4vw] text-[9vw] audiowide-regular leading-none">
              Build <span className="text-blue-400">real-world</span> skills{" "}
              <span className="font-light merienda">that matter</span>
            </h1>

            <p className="sm:text-[1.2vw] text-[3vw] montserrat">
              Join our FREE comprehensive bootcamp and transform yourself into a
              job-ready full stack developer.
            </p>

            <div className="flex flex-wrap gap-2 sm:text-[0.9vw] text-[2.5vw]">
              <span className="bg-blue-900/30 border border-blue-500/30 rounded-full px-3 py-1">
                Frontend
              </span>
              <span className="bg-green-900/30 border border-green-500/30 rounded-full px-3 py-1">
                Backend
              </span>
              <span className="bg-purple-900/30 border border-purple-500/30 rounded-full px-3 py-1">
                React Native
              </span>
              <span className="bg-red-900/30 border border-red-500/30 rounded-full px-3 py-1">
                Linux
              </span>
              <span className="bg-yellow-900/30 border border-yellow-500/30 rounded-full px-3 py-1">
                AI
              </span>
            </div>
          </div>
          ...
          <button
            onClick={handleJoin}
            className="sm:text-[1.2vw] text-[4vw] bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-full sm:py-3 py-2 px-6 text-center flex justify-center items-center sm:w-[15vw] w-fit transition-all duration-300 shadow-lg shadow-blue-500/20"
          >
            Join Now
          </button>
        </div>

        <div className="sm:flex hidden sm:flex-col sm:gap-[2vw] gap-[5vw] sm:w-[25vw] z-10 sm:mt-0 mt-[8vw]">
          {courses.map((course, index) => (
            ...
            >
              ...
              <a
                ...
                className="sm:text-[1vw] text-[2.5vw] border border-blue-400 hover:bg-blue-500 hover:text-white transition-all duration-300 rounded-full sm:py-2 sm:px-[1vw] py-[1vw] px-[2vw] text-center flex justify-center items-center w-fit text-nowrap"
              >
                {course.linkText}
              </a>
            </div>
